...
| [RFC-0030](RFC-0030/) | Backoffice commerce analytics on ClickHouse | platform-wide | P2 | **provisional** — owner opened architecture review 2026-09-07; proposes a 15-minute batch, isolated ClickHouse commerce model, read-only analytics service, and Admin page; decision outcome and two ADRs remain open |
