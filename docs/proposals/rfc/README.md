...
| [RFC-0030](RFC-0030/) | Backoffice commerce analytics on ClickHouse | platform-wide | P2 | **provisional** — PeerDB-first architecture under review: three PostgreSQL CDC mirrors, `pg_cron` target heartbeats, isolated ClickHouse commerce model, freshness ≤2m, read-only analytics service, and Admin page; decision outcome and four ADRs remain open |
