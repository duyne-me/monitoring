...
| [RFC-0030](RFC-0030/) | Backoffice commerce analytics on ClickHouse | platform-wide | P2 | researching — v1 batch/ClickHouse direction, PostgreSQL extension alternatives, and deferred PeerDB CDC dossier audited; owner `ready for RFC` gate remains open |
