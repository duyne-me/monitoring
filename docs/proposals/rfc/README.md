...
| [RFC-0030](RFC-0030/) | Backoffice commerce analytics on ClickHouse | platform-wide | P2 | researching — metric semantics, completed-batch consistency, read-only analytics boundary, and Admin Portal product design; Context7 + benchmark gates remain open |
